...
const newsTemplates = [
  // 基金 (14条)
  { title: '多只权益基金一季度规模翻倍，资金持续涌入优质产品', sentiment: 'positive', cat: '基金' },
  { title: 'ETF总规模突破3万亿，被动投资已成主流配置方式', sentiment: 'positive', cat: '基金' },
  { title: '公募基金降费潮来袭，管理费托管费双双下调利好投资者', sentiment: 'positive', cat: '基金' },
  { title: '债券基金为何持续吸金？10张图看懂债基投资价值', sentiment: 'positive', cat: '基金' },
  { title: 'QDII基金限购频发，海外投资热情高涨但额度告急', sentiment: 'neutral', cat: '基金' },
  { title: '同业存单基金规模破万亿，"闲钱理财"新选择来了', sentiment: 'positive', cat: '基金' },
  { title: '养老FOF基金Y份额：每年最高省税5400元，你开通了吗？', sentiment: 'positive', cat: '基金' },
  { title: '基金清盘数量创新高：为什么迷你基金越来越多？投资者该跑吗', sentiment: 'negative', cat: '基金' },
  { title: 'REITs市场持续扩容：消费基础设施REITs来了，普通人如何参与？', sentiment: 'positive', cat: '基金' },
  { title: '基金净值"回本"了该不该卖？三个问题帮你做决定', sentiment: 'neutral', cat: '基金' },
  { title: '公募基金二季报披露：消费和科技成加仓主线', sentiment: 'positive', cat: '基金' },
  { title: '量化基金超额收益持续衰减，行业格局面临重塑', sentiment: 'neutral', cat: '基金' },
  { title: '基金公司自购潮再起：20家公司自购超30亿元，释放什么信号？', sentiment: 'positive', cat: '基金' },
  { title: '如何判断一只基金是否值得长期持有？看这4个指标就够了', sentiment: 'positive', cat: '基金' },
  // 行业 (8条)
  { title: '医药基金能否王者归来？三大利好正在累积', sentiment: 'positive', cat: '行业' },
  { title: '消费基金迎来转机：五一数据超预期，消费复苏加速', sentiment: 'positive', cat: '行业' },
  { title: '科技主题基金：AI大风口下怎么选基？', sentiment: 'positive', cat: '行业' },
  { title: '半导体基金：周期复苏+国产替代双轮驱动', sentiment: 'positive', cat: '行业' },
  { title: '白酒板块底部确认？茅台批价企稳，消费龙头或将反弹', sentiment: 'positive', cat: '行业' },
  { title: '新能源基金还能买吗？光伏和锂电的两种不同命运', sentiment: 'neutral', cat: '行业' },
  { title: '光伏基金：硅料价格跌破成本线，行业或加速见底', sentiment: 'neutral', cat: '行业' },
  { title: '北向资金连续买入，外资通过ETF布局中国资产的逻辑', sentiment: 'positive', cat: '行业' },
  // 大佬 (6条)
  { title: '张坤最新季报：增持消费医药，看好长期价值回归', sentiment: 'positive', cat: '大佬' },
  { title: '谢治宇致投资者信：在震荡中保持定力，定投是最佳策略', sentiment: 'positive', cat: '大佬' },
  { title: '基金经理变更潮：年内已有200+位基金经理离任，如何应对？', sentiment: 'neutral', cat: '大佬' },
  { title: '葛兰谈医药投资：大跌之后的长期机会', sentiment: 'positive', cat: '大佬' },
  { title: '刘格菘：景气度投资的三个关键信号', sentiment: 'positive', cat: '大佬' },
  { title: '侯昊：白酒行业正在进入一个新的发展阶段', sentiment: 'positive', cat: '大佬' },
  // 策略 (8条)
  { title: '红利基金今年平均收益超15%，高股息策略还能追吗？', sentiment: 'positive', cat: '策略' },
  { title: '新手必看：基金定投选周投还是月投？回测数据告诉你答案', sentiment: 'positive', cat: '策略' },
  { title: '基金定投终极指南：每月投多少、投什么、什么时候停？', sentiment: 'positive', cat: '策略' },
  { title: '基金定投三年还是亏钱，我该放弃吗？', sentiment: 'neutral', cat: '策略' },
  { title: '买基金要不要止损？不同情况的处理方式完全不同', sentiment: 'neutral', cat: '策略' },
  { title: '基金投资中最贵的五个字："这次不一样"', sentiment: 'neutral', cat: '策略' },
  { title: '定投多久能看到收益？历史上三个完整定投周期的启示', sentiment: 'positive', cat: '策略' },
  { title: '基金亏了20%怎么办？三个应对策略帮你渡过难关', sentiment: 'neutral', cat: '策略' },
]
